...
int main(void)
{
    ...
    window = glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "Koch Snowflake", NULL, NULL);
    if (window == NULL)
    {
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        drawPatternFromString(axiom,680,383);
        drawPatternFromString(axiom,300,1040);
        drawPatternFromString(axiom,-80,383);
        if(i<4){
